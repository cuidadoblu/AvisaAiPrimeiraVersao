...
public class Principal {
	...
	public static void main (String[] args) {
		...
		Localidade localidade1 = new Localidade("Rua Vendelino Krauss", "Fortaleza", "Blumenau", "SC", "Materiais de Construção");
		...
		Comunidade comunidade1 = new Comunidade("Comunidade da Fortaleza", "Comunidade para se informar sobre desastres naturais no bairro na Fortaleza", localidade1, null);
